...
<%
    ...
    if (headerRole == null || !"STUDENT".equalsIgnoreCase(headerRole)) {
    ...
    if (headerFirstName == null) headerFirstName = "Student";
...
<header class="top-bar">
    <div class="college-section">
        ...
        <img src="images/logo.jpeg" alt="Blue Ridge University Logo" class="college-logo" style="width: 42px; height: 42px; object-fit: contain;">
        <div>
